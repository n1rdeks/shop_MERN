...
import {
    ...
    PRODUCT_DELETE_SUCCESS, PRODUCT_CREATE_REQUEST,
    PRODUCT_CREATE_SUCCESS, PRODUCT_CREATE_FAIL,
    PRODUCT_UPDATE_FAIL, PRODUCT_UPDATE_SUCCESS,
    PRODUCT_UPDATE_REQUEST, PRODUCT_CREATE_REVIEW_SUCCESS,
    PRODUCT_CREATE_REVIEW_REQUEST, PRODUCT_CREATE_REVIEW_FAIL
...
export const listProducts = (searchKeyword = '', pageNumber = '') => async dispatch => {
    try {
        ...
        const { data } = await axios
            .get(`/api/products?searchKeyword=${searchKeyword}&pageNumber=${pageNumber}`);
